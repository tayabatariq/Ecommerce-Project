...
export default function Productdetail() {
  ...
  const handleAddToCart = () => {
    navigate(""); // Change this to the correct cart route
  };
    ...
    <Grid container spacing={7}>
            ...
            <Box className="mt-5 space-y-3">
                <Grid container alignItems="center" gap={2}>
                      <Grid item xs={2}>
                       ...
                       <Grid item xs={7}>
                          <LinearProgress sx={{bgcolor:"whitesmoke", borderRadius:4, height:7}} variant="determinate" value={50} color="success"/>
                ...
                <Grid container alignItems="center" gap={2}>
                      <Grid item xs={2}>
                       ...
                       <Grid item xs={7}>
                          <LinearProgress sx={{bgcolor:"whitesmoke", borderRadius:4, height:7   ,  "& .MuiLinearProgress-bar": { 
      backgroundColor: "#FFEB3B", 
                      ...
                      <Grid item xs={2}>
                       ...
                       <Grid item xs={7}>
                          <LinearProgress sx={{bgcolor:"whitesmoke", borderRadius:4, height:7}} variant="determinate" value={35} color="primary"/>
                      ...
                      <Grid item xs={2}>
                       ...
                       <Grid item xs={7}>
                          <LinearProgress sx={{bgcolor:"whitesmoke", borderRadius:4, height:7}} variant="determinate" value={20} color="warning"/>
                      ...
                      <Grid item xs={2}>
                       ...
                       <Grid item xs={7}>
                          <LinearProgress sx={{bgcolor:"whitesmoke", borderRadius:4, height:7}} variant="determinate" value={10} color="error"/>
...
{/* Similar Products */}
  <section className="pt-10">
     ...
     {Mens_kurta.map((item)=><HomesectionCrad product={item}/> )}
